...
@ck.command()
@ck.option(
    '--test-data-file', '-tsdf', default=f'data/test_data.pkl',
    help='Test data file')
@ck.option(
    '--terms-file', '-tf', default=f'data/{ont}_terms.pkl',
    help='Data file with sequences and complete set of annotations')
@ck.option(
    '--netgo-scores-file', '-tsf', default=f'data/DeepGraphGO-Ensemble-{ont}-test.txt',
    help='NetGO predictions')
@ck.option(
    '--out_file', '-of', default=f'data/dgg_{ont}.pkl', help='Output file')
